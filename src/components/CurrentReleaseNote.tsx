...
const releaseItems = [
  "Added scripts/refactor-app-date-comparison-helper-b5.mjs to safely replace simple App.tsx past/future date comparison patterns locally.",
  "Added npm script refactor:app-date-comparison for the next Phase B date/time helper replacement step.",
  ...
  "Updated package metadata and visible release notes to identify v3.1.7 as the date comparison helper refactor script baseline.",
];
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-lg font-black text-slate-900">
            v3.1.7 — App.tsx Date Comparison Helper Refactor Script
          </h2>
          <p className="mt-1 text-xs font-semibold leading-relaxed text-slate-600">
            This release adds a local-safe Phase B refactor script to replace simple App.tsx date comparison patterns with shared helper functions.
          </p>
        </div>
        <div className="flex gap-2 text-sky-800">
          <span className="rounded-full bg-white px-3 py-1 text-[10px] font-black uppercase tracking-wider shadow-sm"><Layers size={12} className="mr-1 inline" /> Date Compare</span>
