...
export const USER_MANAGEMENT_PERMISSION_MATRIX = {
  ...
  appointmentWorkflow: [
    "appointmentCreateSchedule",
    "appointmentEditUpdate",
    "appointmentStatusTracking",
    "appointmentTransportCoordination",
    "appointmentProviderCommunication",
    "appointmentFamilyNotification",
    "appointmentDocumentsAttachments",
  ],
  censusResidentData: [
    "residentBoard",
    "residentCreateEdit",
