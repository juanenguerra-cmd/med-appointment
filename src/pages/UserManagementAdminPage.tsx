...
const GROUP_LABELS: Record<string, string> = { modules: "Modules", departments: "Departments", nursingSubsections: "Nursing Subsections" };
const ITEM_LABELS: Record<string, string> = {
  appointments: "Appointments", residents: "Residents / Census", staff: "Staff", providers: "Providers", transportation: "Transportation", reports: "Reports", settings: "Settings", userManagement: "User Management",
  nursing: "Nursing", rehab: "Rehab", socialWork: "Social Work", dietary: "Dietary", maintenance: "Maintenance", administration: "Administration", medicalRecords: "Medical Records",
  appointmentRequests: "Appointment Requests", scheduledAppointments: "Scheduled Appointments", completedAppointments: "Completed Appointments", cancelledAppointments: "Cancelled Appointments", missedAppointments: "Missed Appointments", transportSetup: "Transport Setup", providerCommunication: "Provider Communication", familyNotification: "Family Notification", appointmentDocuments: "Appointment Documents",
};
